...
void draw_credit_text()
{
	...
	strcpy(string[1], "Rishabh Kumar");
	strcpy(string[0], "2K19/CO/314");
...
void RenderScene()
{
	...
	if (page == 1)
	{
		...
		if (!full)
		{
			drawString(-142.0, 63.0, 0.0, "Delhi Technological University");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
			drawString(-87.0, 53.0, 0.0, "Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
			drawString(-119.0, 43.0, 0.0, "Rishabh Kumar - 2K19/CO/314");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
		...
		{
			drawString(-100.0, 65.0, 0.0, "Delhi Technological University");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
			drawString(-75.0, 55.0, 0.0, "Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
			drawString(-90.0, 45.0, 0.0, "Rishabh Kumar - 2K19/CO/314");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0, 0.0, 0.0);
